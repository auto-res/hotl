...
"""
        ...
        messages = [{"role": "system", "content": f"""{default_message}"""}]
        ...
        for i in range(5):
            chat_completion = self.client.chat.completions.create(
                model=self.GPT_id, messages=messages, temperature=0.0
            )
            ans = chat_completion.choices[0].message.content
            old_log = [{"role": "assistant", "content": ans}]
            messages = messages + old_log
            ...
            if ans_json["研究の流れ"] == "Creation of pseudo-algorithms":
                ...
                if "program2" in locals():
                    print("M2_Start")
                    params = {"lr": {"type": "log_float", "args": [1e-5, 1e-3]}}
                    # params = {
...
""",
                    ...
                    old_log = [{"role": "assistant", "content": consideration}]
                    messages = messages + old_log
